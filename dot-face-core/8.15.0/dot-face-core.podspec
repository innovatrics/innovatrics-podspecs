Pod::Spec.new do |s|
    ...
    s.ios.dependency 'dot-core', '8.15.0'
    s.ios.dependency 'dot-serialization', '8.15.0'
    s.ios.dependency 'dot-capture', '8.15.0'
    s.ios.dependency 'dot-camera', '8.15.0'
    s.ios.dependency 'dot-face-commons', '8.15.0'
end
