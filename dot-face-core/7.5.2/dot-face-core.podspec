Pod::Spec.new do |s|
    ...
    s.ios.dependency 'dot-protobuf', '1.5.1'
    s.ios.dependency 'dot-core', '7.5.2'
    s.ios.dependency 'dot-capture', '7.5.2'
    s.ios.dependency 'dot-camera', '7.5.2'
    s.ios.dependency 'dot-face-commons', '7.5.2'
end
