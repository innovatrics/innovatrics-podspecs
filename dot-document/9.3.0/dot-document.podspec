Pod::Spec.new do |s|
    ...
    s.ios.dependency 'dot-core', '9.3.0'
    s.ios.dependency 'dot-serialization', '9.3.0'
    s.ios.dependency 'dot-capture', '9.3.0'
    s.ios.dependency 'dot-camera', '9.3.0'
    s.ios.dependency 'dot-document-commons', '9.3.0'
end
