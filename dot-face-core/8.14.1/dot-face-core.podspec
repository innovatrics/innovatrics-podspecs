Pod::Spec.new do |s|
    ...
    s.ios.dependency 'iface', '6.17.0'
    s.ios.dependency 'dot-protobuf', '1.14.1'
    s.ios.dependency 'dot-core', '8.14.1'
    s.ios.dependency 'dot-serialization', '8.14.1'
    s.ios.dependency 'dot-capture', '8.14.1'
    s.ios.dependency 'dot-camera', '8.14.1'
    s.ios.dependency 'dot-face-commons', '8.14.1'
end
