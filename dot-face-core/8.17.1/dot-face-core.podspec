Pod::Spec.new do |s|
    ...
    s.ios.dependency 'iface', '6.18.0'
    s.ios.dependency 'dot-protobuf', '1.16.2'
    s.ios.dependency 'dot-core', '8.17.1'
    s.ios.dependency 'dot-serialization', '8.17.1'
    s.ios.dependency 'dot-capture', '8.17.1'
    s.ios.dependency 'dot-camera', '8.17.1'
    s.ios.dependency 'dot-face-commons', '8.17.1'
end
