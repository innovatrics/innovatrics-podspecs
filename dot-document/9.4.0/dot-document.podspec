Pod::Spec.new do |s|
    ...
    s.ios.dependency 'dot-core', '9.4.0'
    s.ios.dependency 'dot-serialization', '9.4.0'
    s.ios.dependency 'dot-capture', '9.4.0'
    s.ios.dependency 'dot-camera', '9.4.0'
    s.ios.dependency 'dot-document-commons', '9.4.0'
end
