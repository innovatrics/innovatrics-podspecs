Pod::Spec.new do |s|
    ...
    s.ios.dependency 'dot-core', '8.9.0'
    s.ios.dependency 'dot-serialization', '8.9.0'
    s.ios.dependency 'dot-capture', '8.9.0'
    s.ios.dependency 'dot-camera', '8.9.0'
    s.ios.dependency 'dot-document-commons', '8.9.0'
end
