Pod::Spec.new do |s|
    ...
    s.ios.dependency 'iface', '6.5.0'
    s.ios.dependency 'dot-protobuf', '1.14.0'
    s.ios.dependency 'dot-core', '8.11.0'
    s.ios.dependency 'dot-serialization', '8.11.0'
    s.ios.dependency 'dot-capture', '8.11.0'
    s.ios.dependency 'dot-camera', '8.11.0'
    s.ios.dependency 'dot-face-commons', '8.11.0'
end
