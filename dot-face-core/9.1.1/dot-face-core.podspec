Pod::Spec.new do |s|
    ...
    s.ios.dependency 'dot-core', '9.1.1'
    s.ios.dependency 'dot-serialization', '9.1.1'
    s.ios.dependency 'dot-capture', '9.1.1'
    s.ios.dependency 'dot-camera', '9.1.1'
    s.ios.dependency 'dot-face-commons', '9.1.1'
end
