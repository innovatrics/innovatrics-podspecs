Pod::Spec.new do |s|
    ...
    s.ios.dependency 'dot-protobuf', '1.4.0'
    s.ios.dependency 'dot-core', '6.2.0'
    s.ios.dependency 'dot-capture', '6.2.0'
    s.ios.dependency 'dot-camera', '6.2.0'
    s.ios.dependency 'dot-face-commons', '6.2.0'
end
