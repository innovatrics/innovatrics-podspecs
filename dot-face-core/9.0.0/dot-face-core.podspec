Pod::Spec.new do |s|
    ...
    s.ios.dependency 'dot-core', '9.0.0'
    s.ios.dependency 'dot-serialization', '9.0.0'
    s.ios.dependency 'dot-capture', '9.0.0'
    s.ios.dependency 'dot-camera', '9.0.0'
    s.ios.dependency 'dot-face-commons', '9.0.0'
end
