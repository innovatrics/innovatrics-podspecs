Pod::Spec.new do |s|
    ...
    s.ios.dependency 'dot-core', '9.2.2'
    s.ios.dependency 'dot-serialization', '9.2.2'
    s.ios.dependency 'dot-capture', '9.2.2'
    s.ios.dependency 'dot-camera', '9.2.2'
    s.ios.dependency 'dot-document-commons', '9.2.2'
end
