Pod::Spec.new do |s|
    ...
    s.ios.dependency 'dot-protobuf', '1.10.0'
    s.ios.dependency 'dot-core', '8.6.1'
    s.ios.dependency 'dot-capture', '8.6.1'
    s.ios.dependency 'dot-camera', '8.6.1'
    s.ios.dependency 'dot-document-commons', '8.6.1'
end
